...
class Ingredient():
    ...
    CATEGORIES = {
        'flour', 'water', 'salt', 'starter', 'fat', 'sweetener', 'other'
    }

    def __init__(self, name: str, weight: float=1.0,
                 category: str='other', ratio: float=None):
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            abs(self.weight - other.weight) < 0.1 and
    ...
    @classmethod
    def from_ratio(cls, name: str, flour_weight: float,
...
# flour = Ingredient('Wholeweat', 899, 'flour')
